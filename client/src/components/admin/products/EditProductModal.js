...
const EditProductModal = (props) => {
	...
	useEffect(() => {
		setEditformdata({
			...
			pModel: data.editProductModal.pModel,
			pMake: data.editProductModal.pMake,
			pVariant: data.editProductModal.pVariant,
			pInterior: data.editProductModal.pInterior,
			pExterior: data.editProductModal.pExterior,
		});
